...
.data
    sirasm: .space 1000
    sirvar: .byte 48,48,48,48,48,48,48,48,48,48,48,48,48,48,48,48,48,48,48,48,48,48,48,48,48,48 # la indicele 0 se afla val lui a, la ind 1 val lui b si tot asa
...
et_var:
    ...
    et_verif_var_exista: # dc la indicele variabilei este 0 at nu exista
        movl rez, %edi
        movl $0, %ecx
        movb (%edi, %ecx, 1), %al # in %al punem variabila
        # calculam ecx corect
        movl $1, nr
